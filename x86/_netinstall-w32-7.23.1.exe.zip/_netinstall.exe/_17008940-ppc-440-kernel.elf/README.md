### 17008940-ppc-440-kernel.elf
#### Identification (`file <*>`):
```
ELF 32-bit MSB executable, PowerPC or cisco 4500, version 1 (SYSV), statically linked, BuildID[sha1]=1548cbacf7c1e493775f783696500cdb26a62b1a, stripped
```
#### Analysis (`binwalk <*>`):
```
...
/:
total 5160
-rw-r--r-- 1 root root     492 2026-06-09 10:32:56.119633073 +0100 3e86f8.cpio
-rw-r--r-- 1 root root 5327872 2026-06-09 10:32:57.542666337 +0100 41ca99.cpio
```
