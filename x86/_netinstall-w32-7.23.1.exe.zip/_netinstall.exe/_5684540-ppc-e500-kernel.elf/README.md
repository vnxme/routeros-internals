### 5684540-ppc-e500-kernel.elf
#### Identification (`file <*>`):
```
ELF 32-bit MSB executable, PowerPC or cisco 4500, version 1 (SYSV), statically linked, BuildID[sha1]=bf2395cbca60c66252a2edee3e929dbd438362fa, stripped
```
#### Analysis (`binwalk <*>`):
```
...
/:
total 5160
-rw-r--r-- 1 root root     492 2026-06-09 10:33:28.296392393 +0100 4446b4.cpio
-rw-r--r-- 1 root root 5327872 2026-06-09 10:33:29.707425628 +0100 482c59.cpio
```
