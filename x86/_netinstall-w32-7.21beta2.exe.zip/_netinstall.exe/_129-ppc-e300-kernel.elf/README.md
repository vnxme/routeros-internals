...
#### Identification (`file <*>`):
```
ELF 32-bit MSB executable, PowerPC or cisco 4500, version 1 (SYSV), statically linked, BuildID[sha1]=807f0841b1ca2499dc66e21e295df861a172159b, stripped
```
#### Analysis (`binwalk <*>`):
```
...
/:
total 5288
-rw-r--r-- 1 root root     492 2025-10-10 21:54:57.707064126 +0100 3afc88.cpio
-rw-r--r-- 1 root root 5474304 2025-10-10 21:54:59.854089072 +0100 3e26a1.cpio
```
