...
#### Identification (`file <*>`):
```
ELF 32-bit MSB executable, PowerPC or cisco 4500, version 1 (SYSV), statically linked, BuildID[sha1]=359fabc0428af581af258761e3a1b83ca8e98c04, stripped
```
#### Analysis (`binwalk <*>`):
```
...
/:
total 5288
-rw-r--r-- 1 root root     492 2025-10-10 21:55:02.062114727 +0100 44164c.cpio
-rw-r--r-- 1 root root 5474304 2025-10-10 21:55:04.225137924 +0100 47ec31.cpio
```
