...
#### Identification (`file <*>`):
```
ELF 32-bit MSB executable, PowerPC or cisco 4500, version 1 (SYSV), statically linked, BuildID[sha1]=60f0173af4ad9fd18afd17b47a4041a4b9ea9875, stripped
```
#### Analysis (`binwalk <*>`):
```
...
/:
total 5288
-rw-r--r-- 1 root root     492 2025-10-10 21:55:09.158188157 +0100 3e4698.cpio
-rw-r--r-- 1 root root 5474304 2025-10-10 21:55:11.318213084 +0100 418a71.cpio
```
