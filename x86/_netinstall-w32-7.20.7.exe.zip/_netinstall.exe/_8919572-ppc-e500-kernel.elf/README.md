### 8919572-ppc-e500-kernel.elf
#### Identification (`file <*>`):
```
ELF 32-bit MSB executable, PowerPC or cisco 4500, version 1 (SYSV), statically linked, BuildID[sha1]=b846a1116d48c500852062d59bd8cd6e40de6687, stripped
```
#### Analysis (`binwalk <*>`):
```
...
/:
total 15988
-rw-r--r-- 1 root root      492 2026-01-27 11:37:44.415918484 +0000 44164c.cpio
-rw-r--r-- 1 root root 16793088 2026-01-27 11:37:51.336843608 +0000 47ec21.cpio
```
