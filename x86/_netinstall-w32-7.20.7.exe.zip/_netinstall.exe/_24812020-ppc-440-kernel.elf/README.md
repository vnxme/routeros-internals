### 24812020-ppc-440-kernel.elf
#### Identification (`file <*>`):
```
ELF 32-bit MSB executable, PowerPC or cisco 4500, version 1 (SYSV), statically linked, BuildID[sha1]=839cedfab0f741f7a9e2222971c0f18df22b60f5, stripped
```
#### Analysis (`binwalk <*>`):
```
...
4251805       0x40E09D        Unix path: /home/gitlab-runner/builds/msBP8JuA8/0/dev-rb/ros/ros/ros/kernel/linux6/arch/powerpc/kernel/vdso32
4252649       0x40E3E9        Unix path: /home/gitlab-runner/builds/msBP8JuA8/0/dev-rb/ros/ros/ros/kernel/linux6/arch/powerpc/kernel/vdso32
...
/:
total 15988
-rw-r--r-- 1 root root      492 2026-01-27 11:37:06.153341699 +0000 3e4698.cpio
-rw-r--r-- 1 root root 16793088 2026-01-27 11:37:13.197264502 +0000 418a61.cpio
```
