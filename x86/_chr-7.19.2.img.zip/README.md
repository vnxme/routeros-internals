...
#### Partition IDs (`blkid`):
```
/dev/nbd0p1: LABEL="RouterOS Boot" UUID="a547f24b-9fe4-4ed9-8854-c744bf79fc7c" BLOCK_SIZE="4096" TYPE="ext2"
/dev/nbd0p2: LABEL="RouterOS" UUID="7345db6d-14a6-4104-963e-b330313f4b09" SEC_TYPE="ext2" BLOCK_SIZE="4096" TYPE="ext3"
```
#### MBR info (`fdisk -l <*>`):
```
...
Disk identifier (GUID): A74BEB38-9FA8-5F47-9C5B-9168E3C1702F
...
/:
total 32
-rw-r--r-- 1 root root 17920 2025-06-27 16:06:01.053205715 +0100 gpt.bin
-rw-r--r-- 1 root root   512 2025-06-27 16:06:01.038205573 +0100 mbr.bin
...
/part2/dev:
total 0
brw-r--r-- 1 root root 8, 0 2025-06-20 10:05:00.000000000 +0100 bootdev
brw-r--r-- 1 root root 8, 1 2025-06-20 10:05:00.000000000 +0100 bootpart
