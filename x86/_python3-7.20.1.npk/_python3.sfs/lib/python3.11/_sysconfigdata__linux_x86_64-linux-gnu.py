...
build_time_vars = {
    ...
    "BLDSHARED": "musl-clang -pthread -shared  -Wl,--exclude-libs,ALL",
    "BOOTSTRAP_HEADERS": "\\",
    "BUILDEXE": "",
    "BUILDPYTHON": "python",
    "BUILD_GNU_TYPE": "x86_64-unknown-linux-gnu",
    "BYTESTR_DEPS": "\\",
    "CC": "musl-clang -pthread",
    "CCSHARED": "-fPIC",
    ...
    "CONFIGURE_CFLAGS_NODIST": "-flto -g -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden",
    ...
    "CONFIG_ARGS": "'--build=x86_64-unknown-linux-gnu' '--host=x86_64-unknown-linux-musl' '--prefix=/install' '--with-openssl=/tools/deps' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--with-readline=editline' '--enable-static-libpython-for-interpreter' '--enable-shared' '--with-lto' '--with-build-python=/tools/host/bin/python3.11' '--with-dbmliborder=bdb' 'cross_compiling=yes' 'ac_cv_buggy_getaddrinfo=no' 'ac_cv_file__dev_ptc=no' 'ac_cv_file__dev_ptmx=no' 'ac_cv_working_tzset=yes' 'ac_cv_pthread=yes' 'build_alias=x86_64-unknown-linux-gnu' 'host_alias=x86_64-unknown-linux-musl' 'PKG_CONFIG=pkg-config --static' 'PKG_CONFIG_PATH=/tools/deps/share/pkgconfig:/tools/deps/lib/pkgconfig' 'CC=musl-clang' 'CFLAGS= -fPIC  ' 'LDFLAGS=  -Wl,--exclude-libs,ALL' 'CPPFLAGS= -fPIC  '",
    "CONFINCLUDEDIR": "/install/include",
    "CONFINCLUDEPY": "/install/include/python3.11",
    "COREPYTHONPATH": "",
    "COVERAGE_INFO": "/build/Python-3.11.13/coverage.info",
    "COVERAGE_LCOV_OPTIONS": "--rc lcov_branch_coverage=1",
    "COVERAGE_REPORT": "/build/Python-3.11.13/lcov-report",
    ...
    "LDLIBRARYDIR": "",
    "LDSHARED": "musl-clang -pthread -shared  -Wl,--exclude-libs,ALL",
    "LDVERSION": "3.11",
    "LIBC": "",
    "LIBDEST": "/install/lib/python3.11",
    "LIBDIR": "/install/lib",
    "LIBEXPAT_A": "Modules/expat/libexpat.a",
    "LIBEXPAT_CFLAGS": "-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC   -flto -g -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -fPIC   -fPIC -fPIC",
    "LIBEXPAT_HEADERS": "\\",
    "LIBEXPAT_OBJS": "\\",
    "LIBFFI_INCLUDEDIR": "",
    "LIBM": "-lm",
    "LIBMPDEC_A": "Modules/_decimal/libmpdec/libmpdec.a",
    "LIBMPDEC_CFLAGS": "-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC   -flto -g -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -fPIC   -fPIC -fPIC",
    "LIBMPDEC_HEADERS": "\\",
    "LIBMPDEC_OBJS": "\\",
    "LIBOBJDIR": "Python/",
    "LIBOBJS": "",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/build/Python-3.11.13 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /build/Python-3.11.13/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu /tools/host/bin/python3.11",
    ...
    "PY_BUILTIN_MODULE_CFLAGS": "-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC   -flto -g -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -fPIC   -fPIC -DPy_BUILD_CORE_BUILTIN",
    "PY_CFLAGS": "-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC  ",
    "PY_CFLAGS_NODIST": "-flto -g -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal",
    "PY_COERCE_C_LOCALE": 1,
    "PY_CORE_CFLAGS": "-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC   -flto -g -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -fPIC   -fPIC -DPy_BUILD_CORE",
    ...
    "PY_STDMODULE_CFLAGS": "-fno-strict-aliasing -DNDEBUG -g -fwrapv -O3 -Wall -fPIC   -flto -g -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -fPIC   -fPIC",
    "PY_SUPPORT_TIER": 0,
    "Py_DEBUG": 0,
    "Py_ENABLE_SHARED": 1,
    "Py_HASH_ALGORITHM": 0,
    ...
    "RETSIGTYPE": "void",
    "RUNSHARED": "LD_LIBRARY_PATH=/build/Python-3.11.13",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "LD_LIBRARY_PATH=/build/Python-3.11.13 _PYTHON_PROJECT_BASE=/build/Python-3.11.13 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /build/Python-3.11.13/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu /tools/host/bin/python3.11",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "LD_LIBRARY_PATH=/build/Python-3.11.13 _PYTHON_PROJECT_BASE=/build/Python-3.11.13 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /build/Python-3.11.13/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu /tools/host/bin/python3.11 ./Tools/scripts/run_tests.py",
    ...
    "abs_builddir": "/build/Python-3.11.13",
    "abs_srcdir": "/build/Python-3.11.13",
