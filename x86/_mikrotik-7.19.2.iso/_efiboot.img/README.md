...
#### Partition IDs (`blkid`):
```
/dev/nbd0: LABEL_FATBOOT="ROUTEROS" LABEL="ROUTEROS" UUID="42B3-6FA8" BLOCK_SIZE="512" TYPE="vfat"
```
...
-rw-r--r-- 1 root root 512 2025-07-05 21:02:25.648505474 +0100 mbr.bin
