...
if(!this.newObj&&(type.type=="map")&&!type.nonaddable&&!type.ro){this.copy=this.addActionButton("Copy",copyCfg);this.copy.onclick=e=>{this.obj._owner.copySource=this.obj;openContent(getPath(this.attrs)+".copy",true);}}
