...
--------------------------------------------------------------------------------
3776136       0x399E88        Ubiquiti partition header, header size: 56 bytes, name: "PARTLABEL=", base address: 0x6E667300, data size: 0 bytes
...
4036135       0x3D9627        Intel x86 or x64 microcode, sig 0x03000000, pf_mask 0x00, 1C88-16-31, rev 0x-65c14000, size 1
4036167       0x3D9647        Intel x86 or x64 microcode, sig 0x03000000, pf_mask 0x00, 1C90-16-20, rev 0x-65c14000, size 2048
4036295       0x3D96C7        Intel x86 or x64 microcode, sig 0x03000000, pf_mask 0x00, 1CB4-14-30, rev 0x-65c14000, size 33
4065267       0x3E07F3        Copyright string: "Copyright 2005-2007 Rodolfo Giometti <giometti@linux.it>"
4074228       0x3E2AF4        Unix path: /sys/firmware/devicetree/base
...
4164360       0x3F8B08        Neighborly text, "NeighborSolicitsp6InMsgs"
4164380       0x3F8B1C        Neighborly text, "NeighborAdvertisementsrs"
...
/:
total 4
-rw-r--r-- 1 root root 492 2026-01-27 11:38:30.787413845 +0000 480ad4.cpio
```
