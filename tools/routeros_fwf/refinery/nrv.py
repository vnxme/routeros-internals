...
from .structures import StructReader, MemoryFile
from .decompression import BitBufferedReader
# from .units import Unit, Arg


class NRVUnit(metaclass=abc.ABCMeta):
    """
    ...
    def process(self, data):
        def process(length_prefix: bool):
            ...
            bbr = BitBufferedReader(src, self.bits)
