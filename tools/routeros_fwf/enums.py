...
# https://git.sceen.net/linux/linux-stable.git/commit/include?id=05dc8c02bf40090e9ed23932b1980ead48eb8870
...
MAGIC = {
    ...
    b'\x30\x30\x31\x37': {'be': True,  'magic': '7100', 'platform': 'ar7100', 'arch': 'mipsbe', 'soc': 'Atheros AR7100'},
    # b'\x30\x30\x31\x37': {'be': True,  'magic': '7100', 'platform': 'ar7100', 'arch': 'mipsbe', 'soc': 'Atheros AR7100'},
    b'\x31\x34\x32\x37': {'be': True,  'magic': '7241', 'platform': 'ar7240', 'arch': 'mipsbe', 'soc': 'Atheros AR7240'},
    # b'\x31\x34\x32\x37': {'be': True,  'magic': '7241', 'platform': 'ar7240', 'arch': 'mipsbe', 'soc': 'Atheros AR7240'},
    b'\x30\x33\x33\x39': {'be': True,  'magic': '9330', 'platform': 'ar9330', 'arch': 'mipsbe', 'soc': 'Atheros AR9330'},
    # b'\x30\x33\x33\x39': {'be': True,  'magic': '9330', 'platform': 'ar9330', 'arch': 'mipsbe', 'soc': 'Atheros AR9330'},
    b'\x4c\x33\x33\x39': {'be': True,  'magic': '933L', 'platform': 'ar9330L', 'arch': 'mipsbe', 'soc': 'Atheros AR9330'},
    b'\x30\x34\x33\x39': {'be': True,  'magic': '9340', 'platform': 'ar9340', 'arch': 'mipsbe', 'soc': 'Atheros AR9340'},
    # b'\x30\x34\x33\x39': {'be': True,  'magic': '9340', 'platform': 'ar9340', 'arch': 'mipsbe', 'soc': 'Atheros AR9340'},
    b'\x6c\x34\x33\x39': {'be': True,  'magic': '934l', 'platform': 'ar9340L', 'arch': 'mipsbe', 'soc': 'Atheros AR9340'},
    b'\x34\x34\x33\x39': {'be': True,  'magic': '9344', 'platform': 'ar9344', 'arch': 'mipsbe', 'soc': 'Atheros AR9344'},
    # b'\x34\x34\x33\x39': {'be': True,  'magic': '9344', 'platform': 'ar9344', 'arch': 'mipsbe', 'soc': 'Atheros AR9344'},
    ...
    b'\x38\x35\x31\x33': {'be': True,  'magic': '8513', 'platform': 'qca8513', 'arch': 'mipsbe', 'soc': 'Qualcomm Atheros QCA8513'},
    # b'\x38\x35\x31\x33': {'be': True,  'magic': '8513', 'platform': 'qca8513', 'arch': 'mipsbe', 'soc': 'Qualcomm Atheros QCA8513'},
    ...
    b'\x4c\x33\x35\x39': {'be': True,  'magic': '953L', 'platform': 'qca9531L', 'arch': 'mipsbe', 'soc': 'Qualcomm Atheros QCA9531'},
    # b'\x4c\x33\x35\x39': {'be': True,  'magic': '953L', 'platform': 'qca9531L', 'arch': 'smips', 'soc': 'Qualcomm Atheros QCA9531'},
    b'\x30\x35\x35\x39': {'be': True,  'magic': '9550', 'platform': 'qca9550', 'arch': 'mipsbe', 'soc': 'Qualcomm Atheros QCA9550'},
    # b'\x30\x35\x35\x39': {'be': True,  'magic': '9550', 'platform': 'qca9550', 'arch': 'mipsbe', 'soc': 'Qualcomm Atheros QCA9550'},
