...
#### Partition IDs (`blkid`):
```
/dev/nbd0p1: UUID="432B-3279" BLOCK_SIZE="512" TYPE="vfat"
/dev/nbd0p2: UUID="cda03a87-6fc9-44a2-bd40-43bf9181bea1" BLOCK_SIZE="4096" TYPE="ext4"
```
#### MBR info (`fdisk -l <*>`):
```
...
Disk identifier (GUID): 91DEC52D-8B54-49F0-905D-7EBF6CA01DD8
...
/:
total 29
-rw-r--r-- 1 root root 17920 2025-07-05 21:02:19.231426775 +0100 gpt.bin
-rw-r--r-- 1 root root   512 2025-07-05 21:02:19.218427005 +0100 mbr.bin
