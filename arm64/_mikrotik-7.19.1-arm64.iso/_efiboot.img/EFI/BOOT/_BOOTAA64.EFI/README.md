...
8322994       0x7EFFB2        xz compressed data
8592763       0x831D7B        Unix path: /lib/firmware/updates/5.6.3
8674499       0x845CC3        Copyright string: "Copyright 2005-2007 Rodolfo Giometti <giometti@linux.it>"
8708487       0x84E187        Unix path: /sys/firmware/devicetree/base
8709980       0x84E75C        Unix path: /sys/firmware/fdt': CRC check failed
8728202       0x852E8A        Neighborly text, "neighbor table overflow!ighbour cache statistics"
8756549       0x859D45        Neighborly text, "NeighborSolicitss"
8756566       0x859D56        Neighborly text, "NeighborAdvertisementscmp6OutMsgs"
...
10792964      0xA4B004        xz compressed data
```
#### Listing (`ls -AlR <*>`):
```
/:
total 1556
-rw-r--r-- 1 runner docker     492 2025-06-05 12:57:11.971782378 +0100 90aa30.cpio
-rw-r--r-- 1 runner docker 1587200 2025-06-05 12:57:12.737790502 +0100 a4b004.cpio
```

#### Replacements (`ln -sfr <*> <*>`):
```
arm64/_mikrotik-7.19.1-arm64.iso/_efiboot.img/EFI/BOOT/_BOOTAA64.EFI/90aa30.cpio arm64/_routeros-7.19.1-arm64.npk/system.files/boot/_kernel/_13038.vmlinux/90aa30.cpio
```
