...
10768388      0xA45004        xz compressed data
```
#### Listing (`ls -AlR --time-style=full-iso <*>`):
```
/:
total 1552
-rw-r--r-- 1 root root     492 2025-09-03 12:24:22.982327125 +0100 908a14.cpio
-rw-r--r-- 1 root root 1582592 2025-09-03 12:24:23.757330485 +0100 a45004.cpio
```
