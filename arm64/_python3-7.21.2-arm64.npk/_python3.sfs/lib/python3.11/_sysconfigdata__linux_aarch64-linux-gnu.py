...
build_time_vars = {'ABIFLAGS': '',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.11.11/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/Python-3.11.11/lcov-report',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.11.11 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.11.11/`cat pybuilddir.txt`:)./Lib '
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -fPIC '
                   ...
                   '  -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': ' -Wl,--exclude-libs,ALL -flto '
                    '-fuse-linker-plugin -ffat-lto-objects '
                    '-flto-partition=none -g',
 ...
 'PY_LDFLAGS_NODIST': '-flto -fuse-linker-plugin -ffat-lto-objects '
                      '-flto-partition=none -g',
 'PY_LDFLAGS_NOLTO': ' -Wl,--exclude-libs,ALL -fno-lto',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.11.11',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.11.11 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.11.11 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.11/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
               '/tools/host/bin/python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.11.11 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.11.11 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.11.11/`cat pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/build/Python-3.11.11',
 'abs_srcdir': '/build/Python-3.11.11',
